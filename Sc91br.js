        ...
        if (switch_board.its_plp_page) {
            if (pr != sp && sp != 0) {
                ...
                if (act_mobile != null) {
                    ...
                    if (act_mobile.querySelectorAll('.price_bind .price_org_spl_wrap .inc_special_price')[0] != undefined || act_mobile.querySelectorAll('.price_bind .price_org_spl_wrap .inc_special_price')[0] != undefined) {
                    ...
                    if (inc_active_tab.querySelectorAll('.price_bind .price_org_spl_wrap .inc_special_price')[0] != undefined || inc_active_tab.querySelectorAll('.price_bind .price_org_spl_wrap .inc_special_price')[0] != undefined) {
            ...
            if (switch_board.its_plp_page) {
                if (inc_active_tab.querySelectorAll('.inc_price')[1] != undefined) {
                    if (pr != sp && sp != 0) {
                        ...
                        if (inc_active_tab.querySelectorAll('.price_bind .price_org_spl_wrap .inc_special_price')[1] != undefined || inc_active_tab.querySelectorAll('.price_bind .price_org_spl_wrap .inc_special_price')[1] != undefined) {
...
function get_product_quantity_box(products_data, prod_price, ic_prod, collection, combo) {
    ...
    for (let i = 0; i < res_tocheck.ComboSetCount; i++) {
        if (i == 0) {
            ...
            for (cb = 0; cb < res_tocheck.ComboSet[i].BundleCount; cb++) {
                ...
                for (let j = 0; j < res_tocheck.ComboSet[i].Bundles[cb].Products.length; j++) {
                    if (isBase64(res_tocheck.ComboSet[i].Bundles[cb].Description) == true) {
                        ...
                        res_tocheck.ComboSet[i].Bundles[cb].Description = res_tocheck.ComboSet[i].Bundles[cb].Description
                    }
                    if (isBase64(res_tocheck.ComboSet[i].Bundles[cb].Field1) == true) {
                        ...
                        res_tocheck.ComboSet[i].Bundles[cb].Field1 = res_tocheck.ComboSet[i].Bundles[cb].Field1
                    }
            ...
            if (isBase64(product_data_desc.Description) == true) {
                ...
                product_data_desc.Description = product_data_desc.Description
            }
            if (isBase64(product_data_desc.Field1) == true) {
                product_data_desc.Field1 = Base64.decode(product_data_desc.Field1)
            } else {
                product_data_desc.Field1 = product_data_desc.Field1
            }
                    ...
                    if ((load_type == 'onload') || ((!switch_board.catogory_tab) && (load_type == 'btn_click'))) {
                        ...
                        if (combo_created_prod_list.indexOf(products_data.ProductId) >= 0) {
                            if (dup_combo_p_id.indexOf(products_data.ProductId) == -1) {
                                ...
                                if (window.innerWidth > 767) {
                                    // prod_wise_wrapper.appendChild(added_prd_cont)
                                } else {
                                    // prod_addon_wrapper.appendChild(added_prd_cont)
                                }
                                if (i == 0 && j == 0) {
...
function create_product_combo_box(load_type, products_data, product_attributes, ic_product_bundling, index, prod_bundle, new_temp, p_ind) {
    ...
    if (isBase64(products_data.Description) == true) {
        ...
        products_data.Description = products_data.Description
    }
    if (isBase64(products_data.Field1) == true) {
        products_data.Field1 = Base64.decode(products_data.Field1)
    } else {
        products_data.Field1 = products_data.Field1
    }
