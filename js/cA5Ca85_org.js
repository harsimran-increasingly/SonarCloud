(function () {
    ...
    INC.config.clientToken = "cA5Ca85";
    INC.config.trackingURL = "https://optimizedby.increasingly.co/ImportData";
    INC.config.addToBasketURL = "https://www.chaoscards.co.uk/";
    INC.clientConfig.checkoutLink = "https://www.chaoscards.co.uk/basket";
    ...
    INC.config.noimage =
        "https://www.increasingly.co/Clients/cA5Ca85/images/no-image.jpg";
    ...
    INC.init = function () {
        ...
        switch (INC.config.pageType) {
            case "pdp":
                ...
                if (clientATC != null) {
                    if (
                        document.querySelector(".product-detail__content")
    ...
    function cartpageprodids() {
        ...
        let cartPageItems = document.querySelectorAll(".cart-item__save-link");
        for (const element of cartPageItems) {
            let postAjax = JSON.parse(element.dataset.ajaxPost);
            let item_id = postAjax.item_id;
            INC.config.cartproductids.push(item_id);
        }
    ...
    INC.classes.ProductObj = function (product) {
        ...
        if (product["Field6"] !== "") {
            this.regularPrice = (
                parseFloat(product["Field6"]) / 100
            ).toString();
            let field6Price = this.regularPrice;
            this.regularPriceMain = field6Price;

            if (
                product["SpecialPrice"] != null &&
                product["SpecialPrice"] != this.regularPrice &&
                Number(product["SpecialPrice"]) != 0
            ) {
                if (
                    parseFloat(product["SpecialPrice"]) >
                    parseFloat(this.regularPrice)
                ) {
                    this.regularPrice = product["SpecialPrice"];
                    this.activePrice = field6Price;
                    this.regularPriceMain = product["SpecialPrice"];
                    this.activePriceMain = field6Price;
                } else {
                    this.activePrice = product["SpecialPrice"];
                }
            } else {
    ...
    INC.classes.ProductAttObj = function (product) {
        ...
        if (product != null && product != undefined) {
            ...
            this.option[product["optionId"]].opt_id =
                product["optionId"] != null ? product["optionId"] : "";
    ...
    INC.methods.detectPageType = function () {
        if (document.querySelector(".product") != null) return "pdp";
        if (document.querySelector(".collection-page") != null)
            return "productList";
        if (document.querySelector(".checkout-layout") != null)
            return "cartPage";
    };
            ...
            if (
                ...
                setTimeout(() => {
                    window.location.replace(
                        "https://www.chaoscards.co.uk/basket"
                    );
                }, 1000);
                return;
            }
    ...
    INC.methods.createAMBlock = function (PDP_type) {
        if (INC.dataStore.dataStoreObj.undefined == undefined) {
            ...
            if (PDP_type == "PDP") {
                ...
                if (bundleProductsArray.length > 0) {
                    var CartPos = document.querySelector(
                        ".cart-based-on-basket"
                    );
                    if (CartPos != null) {
        ...
        let allClientRemoveButton = document.querySelectorAll(
            "#checkout-cart-table .cart-item__delete"
        );
        for (const element of allClientRemoveButton) {
            element.addEventListener("click", function () {
                let client_popup = setInterval(() => {
                    let cartPageClientRemove = document.querySelector(
                        ".core_button_prev.add_to_cart_continue"
                    );
                    if (cartPageClientRemove) {
                        clearInterval(client_popup);
                        cartPageClientRemove.addEventListener(
                            "click",
                            function () {
                                setTimeout(() => {
                                    INC.clientConfig.offset = 0;
    ...
    function addprodsingle(element) {
        ...
        var add_btn = productBlockNode.querySelector(
        ...
        if (sidebar != "sidebar" && sidebar != "hidesidebar") {
            if (
                ...
                for (var iq = 0; iq < productVisibleCount; iq++) {
                    ...
                    var productListItemBlock = this.createProductListItemBlock(
                ...
                if (
                    ...
                    var thirdbundleimgsrc = pdpBlock
                        ...
                        .getAttribute("data-src");
                    toplevelbundleblock =
                        "<div class='inc_bundle_avail_img first'><img src='" +
                        mainprodimgsrc +
                    ...
                    toplevelbundleblock =
                        "<div class='inc_bundle_avail_img first'><img src='" +
                        mainprodimgsrc +
                        "'></div><span></span> <div class='inc_bundle_avail_img third'><img src='" +
                        secbundleimgsrc +
                        "'></div><div class='inc_bundle_avail_btn'>Bundle available</div>";
                }
                ...
                var pdpbundleel = document.querySelector(
                    ".prod_det_fields.left.product-section.product-section--add-to-cart"
                );
                if (window.innerWidth < 769) {
                    pdpbundleel = document.querySelector(
                        ".prod_det_fields.left.product-section.product-section--add-to-cart"
                    );
                }
                ...
                if (
                    document.querySelectorAll(
                        ".product-wrapper .product-form__item .image-radio input"
                    ) != null
                ) {
                    ...
                    if (pdpbundleel != null) {
                        if (
                            ...
                            pdpbundleel.parentNode.insertBefore(
                                inc_bundle_avail_block,
                                pdpbundleel.nextElementSibling
                            );
                        }
                    }
                } else if (pdpBlockSibling != null) {
                ...
                setTimeout(function () {
                    ...
                    var all_list_el = document.querySelectorAll(
                        ".inc_pdp_bundle_product_list_block .inc_product_showcase_block"
                    );
                ...
                if (sidebarsaveprc != 0) {
                    if (
                        ...
                        document.querySelector(
                            ...
                            "You save " + formatter.format(sidebarsaveprc);
                    }
                }
    ...
    INC.methods.addProductToSidebarCart = function (
        ...
        if (sbBlock != null) {
            ...
            if (INC.clientConfig.OOS.indexOf(productObj.mainId) >= 0) {
                ...
                if (client_add_btn == "client_add_btn") {
                    activepriceClnt =
                        document.querySelector(".price_inc").innerText;
                    pdpprice = document.querySelector(".old_price");
                    if (pdpprice == null) {
                        pdpprice = 0;
                    } else {
                        pdpprice = pdpprice.innerText.split("Was")[1];
                    }
                    if (qty > 1) {
                ...
                if (client_add_btn == "client_add_btn") {
                    if (activepriceClnt != 0 && pdpprice != 0) {
                        activePrice = Number(
                            activepriceClnt.replace("£", "").replace("£", "")
                        ).toString();
                        regularPrice = Number(
                            pdpprice.replace("£", "").replace("£", "")
                        ).toString();
                    } else if (pdpprice != 0) {
                        activePrice = Number(
                            pdpprice.replace("£", "").replace("£", "")
                    ...
                    activePrice = Number(
                        productObj.activePrice.replace("£", "").replace("£", "")
                    ).toString();
                    regularPrice = Number(
                ...
                if (
                    ...
                    if (
                        ...
                        document.querySelector(
                            ...
                            "You save " + formatter.format(sidebarsaveprcw);
                    }
                } else {
                    elHeadersubtotalactivetext.style.color = "#000";
                    elHeadersubtotalactivetext.innerHTML =
    ...
    INC.methods.createProductModuleBlock = function (
        ...
        if (INC.dataStore.dataStoreObj.undefined == undefined) {
            ...
            if (INC.bundles) {
                ...
                var productShowcaseBlock =
                    INC.methods.createProductShowcaseBlock(
                        pdpProductId,
                        blockType,
                        bundleProductListCheck,
                        pdpblockel,
    ...
    INC.methods.createProductShowcaseBlock = function (
        ...
        var productAddButton = productBlock.querySelector(
            ".inc_product_add_block"
        );
        var elQtyAddBtnBlock = productBlock.querySelector(
            ".inc_product_desc_qty_add_btn_block"
        );
        var elRrpLabelBlock = productBlock.querySelector(
            ".inc_product_rrp_label_block"
        );
        ...
        productLink.addEventListener("click", function (e) {
            ...
            e.preventDefault();
            var href = productBlock.querySelector(
                ".inc_product_desc_title_text a"
            ).href;
            setTimeout(function () {
        ...
        var regularPrice = parseFloat(productObj.regularPriceMain)
            .toFixed(2)
            .toString();
        var rrpPrice = parseFloat(productObj.rrpPrice).toFixed(2).toString();
        ...
        if (
            ...
            elPriceRegularText.innerHTML =
                "Was " + formatter.format(regularPrice);
            elproductPriceLabel.innerHTML =
                "Save " + formatter.format(totalsaveprc);
        } else {
            elPriceActiveText.innerHTML = formatter.format(activePrice);
            elworthPrice.innerHTML = "";
        }
        if (rrpPrice) {
            elRrpLabelBlock.innerText = "RRP " + rrpPrice;
        } else {
            elRrpLabelBlock.innerText = "";
        }
        if (window.innerWidth < 769) {
            ...
            if (
                (this.textContent.trim() == "Update" ||
                    this.parentNode.classList.contains("config_avail") ==
                        trueflag) &&
                this.innerText.trim() != "Add To Basket"
            ) {
                ...
                if (
                    ...
                    if (flag_check == 1 || flag_check == 3) {
                        ...
                        productBlock.classList.remove("show_overlay");
                        if (
                            this.textContent.trim() == "Add To Basket" ||
            ...
            if (
                ...
                if (elAddText.textContent == "Add") {
                    if (prodflag == trueflag) {
                        ...
                        var titlesel = productModuleBlock
    ...
    function eladdfn_(productModuleBlock) {
        if (
            ...
            productModuleBlock
                .querySelector(".inc_product_variant_simple_text")
                .setAttribute("title", "Select Option");
        }
        if (
            productModuleBlock.querySelector(
                ".inc_product_variant_simple_block"
    ...
    INC.methods.createProductModalBlock = function (
        ...
        if (window.innerWidth < 821) {
            let headerImageBlock = elHeader.querySelector(
    ...
    function productzeroatt(
        ...
        elAtt0TitleText.innerText =
            product0Obj["att0Array"][0].label.toLowerCase();
        if (window.innerWidth < 769) {
        ...
        product0Obj["att0Array"].forEach(function (sizeObj) {
            ...
            attSizeImgBlock0.setAttribute(
                "data-size",
                sizeObj["text"].replace(/"/g, "")
            );

            attSizeImgBlock0.setAttribute(
                "datasize",
                sizeObj["text"].toLocaleLowerCase().replace(/"/g, "")
            );
    ...
    INC.methods.mappvariants = function (obj, blocktype, type_of_variant) {
        if (obj.parentNode != undefined) {
            ...
            if (type_of_variant == "zero") {
                ...
                productblockmod
                    .querySelector(".inc_product_desc_att_block")
                    .setAttribute("data-size", sel_variantS.replace(/"/g, ""));
                productblockshow
                    .querySelector(".inc_product_desc_att_block")
                    .setAttribute("data-size", sel_variantS.replace(/"/g, ""));
            ...
            if (
                ...
                if (
                    productblockmod.querySelector(
                        '.inc_product_desc_att_size_list_block .inc_product_desc_att_size_list_item_img_block[datacolor="' +
                            sizelowertext +
                            '"]'
                    ) != null
                ) {
            ...
            if (
                ...
                if (
                    productblockmod.querySelector(
                        ".inc_product_desc_att_third_list_block .inc_product_desc_att_size_list_item_img_block.inc_active"
                    ) != null
                ) {
                    productblockmod
                        .querySelector(
                ...
                productblockmod
                    .querySelector(
                        '.inc_product_desc_att_third_list_block .inc_product_desc_att_size_list_item_img_block[datacolor="' +
                            thirdlowertext +
                            '"]'
                    )
                    .classList.add("inc_active");
        ...
        if (elPdpBundleCartBlock != null) {
            ...
            if (
                ...
                elbundlesavetext.innerHTML =
                    "You save " + formatter.format(totalsaveprcs);
            } else {
                elbundlesavetext.innerHTML = "";
                elBundleCartPriceRegularText.parentNode.parentNode.parentNode.classList.add(
                    "simple_ecirp"
    ...
    INC.methods.addProductToCart = function (
        ...
        let hashes = [
            "c9dbd1dd4ec7c7f9d0719d6289d7b90ea505aefbf0d53ad2ba1189eea4a11b13e8dfeaba9df924a250248694d280da3a349b1839a07d9e3dc2ba80760bdc981d",
            "a99caf58e5a2846d9e7a98faa4db7d98d1743c595a1f99e226e0e886b299286c464208ab7cc647dbc4257641d19a30c6f84bdff95d1b543500b9582468304a92",
        ];
        let ga_id = readCookie("_ga");

        if (INC.config.pageType == "cartPage") {
            let origins = new URL(productObj.url);
            origins = origins.pathname;
            params =
                "ajax_hash%5B%5D=" +
                hashes[0] +
                "&ajax_hash%5B%5D=" +
                ...
                "&pid=" +
                productObj.sku +
                "&ajax_origin=add_to_cart_form_" +
                productObj.sku +
                "&add_to_cart_form_" +
                productObj.sku +
                "&module=cart&ajax_act=do_add_to_cart&_ga_client_id=" +
                ga_id +
                "&rp=" +
                rp +
                "&window_location=" +
                origins +
                "&window_location_query_string=" +
                origins;
        } else {
            params =
                "ajax_hash%5B%5D=" +
        ...
        if (rec_type == trueflag) {
            ...
            INC.config.pdpaddedProductList.push(
                INC.config.Product_id.toString()
            );

            if (productObj.mainId != undefined) {
                INC.config.pdpaddedProductList.push(
                    productObj.mainId.toString()
                );
            }
            checkAddedProductInJustAdded();
        }
            ...
            error: function (res) {
                if (res != undefined) {
                    if (res.responseJSON != undefined) {
                        if (
                            res.responseJSON.message == "Cart Error" ||
                            res.responseJSON.message == "Cart System downtime"
                        ) {
                            ...
                            if (
                                ...
                                if (
                                    document.querySelector(
                                        ".mini-cart-content .mini-cart-product .minicart-remove-button"
                                    ) != null
                                ) {
                                    var itemid = document
                                        .querySelector(
                                    ...
                                    var elmcartitem = document.querySelector(
                                        '.mini-cart-content .mini-cart-product .minicart-remove-button[aria-describedby="' +
                                            itemid +
                                            '"]'
                                    );
                                    if (elmcartitem != null) {
                                        elmcartitem =
                                            elmcartitem.parentNode.parentNode
                                                .parentNode;
                                    }
                                    if (elmcartitem != null) {
                                        elmcartitem
                                            .querySelector(".btn-add-quantity")
                                            .click();
                                        setTimeout(function () {
                                            var elmcartitem_ =
                                                document.querySelector(
        ...
        if (
            ...
            if (INC.config.pageType == "pdp") {
                if (INC.config.OOSProduct) {
                    ...
                    INC.config.recommendationProduct.includes(
                        eventdata__.product_id
                    )
                ) {
                    rpt_val = "4";
                } else {
    ...
    INC.methods.addBundleToCart = function (btn_cart, recsType) {
        ...
        Object.keys(dataStore.bundleCartProducts).forEach(function (
            ...
            let hashes = JSON.parse(
                document.querySelector(".product__right form").dataset.ajaxHash
            );
            let ga_id = readCookie("_ga");
            ...
            params =
                ...
                Date.now() +
                "&qty=" +
                INC.dataStore.bundleCartProducts[productObj.sku] +
                "&pid=" +
                productObj.sku +
                "&ajax_origin=add_to_cart_form_" +
                productObj.sku +
            ...
            qtyArray.push(INC.dataStore.bundleCartProducts[productObj.sku]);
            count_pr_to_add++;
    ...
    function clickListener(e) {
        ...
        if (clickedElement != null) {
            try {
                ...
                if (clickedElement !== null) {
                    if (
                        clickedElement.className == "prod_det_add_to_cart" ||
                        clickedElement.className == "cf add_to_cart" ||
                        clickedElement.className ==
                            "submit_button button addtocart" ||
                        clickedElement.className ==
                            "submit_button button addtocart shrouded"
                    ) {
                        ...
                        let elPDP = document.querySelector(".pricing_wrapper");
                        INC.config.pdpaddedProductList = [];
                        INC.config.pdpaddedProductList.push(
                            INC.config.Product_id
                        );
    ...
    function autoselect_(textsel) {
        setTimeout(function () {
            if (textsel == null) {
                if (
                    document.querySelector('select[name="options[33]"]') != null
                ) {
                    var selvar = document.querySelector(
                        'select[name="options[33]"]'
                    );
                    textsel = selvar.options[selvar.selectedIndex].innerText
                        .trim()
                        .toLocaleLowerCase();
                }
            }
            ...
            for (var alistel in all_list_el) {
                if (
                    all_list_el[alistel] != null &&
                    Object.prototype.hasOwnProperty.call(all_list_el, alistel)
                ) {
                    if (
                    ...
                    if (
                        all_list_el[alistel].querySelector(
                            '.inc_product_desc_att_color_block .inc_product_desc_att_color_list_item_img_block[datacolorfabric="' +
                                textsel +
                                '"] div'
                        ) != null
                    ) {
    ...
    function inc_showSlides(n, _ind, elm, _type_of, arrow) {
        ...
        if (img_src != "null") {
            ...
            showcase_other_img.setAttribute(
                "onerror",
            ...
            if (showcase_dots[INC.config.inc_slideIndex - 1] != null) {
                showcase_dots[INC.config.inc_slideIndex - 1].classList.add(
                    "inc_active"
                );
            }
    ...
    function incPriceMismatch(active_price, special_price, product_id) {
        ...
        let elProductPrice = document.querySelector(".price-standard");
        let elSpecialPrice = document.querySelector(".price-sales");

        let clientSpecialPrice = elSpecialPrice
            ? Number(elSpecialPrice.innerText.replace(/[^0-9.-]+/g, ""))
            : null;
        let clientProductPrice = Number(
        ...
        let final_old_client_special_price =
            Number(special_price) == 0 ? null : Number(special_price);
    ...
    function oosproduct(prdid) {
        ...
        if (product_id != null) {
            ...
            var p_url =
                "https://gather.increasingly.com/ProductInventoryUpdate";
            var xhr = new XMLHttpRequest();
            xhr.open("POST", p_url, true);
            xhr.onreadystatechange = function () {
    ...
    function updateMiniCart(resp) {
        try {
            if (INC.config.pageType == "pdp") {
                let parentElement = document.querySelector("#header-cart");

                parentElement.innerHTML = resp.update_elements[0].html;
            }
        } catch (error) {
            console.log(error);
        }
